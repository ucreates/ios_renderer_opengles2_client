...
@interface RectangleTextureBehaviour1 ()
@end
@implementation RectangleTextureBehaviour1
@synthesize asset;
- (id)init {
    self = [super init];
    ...
    if (0 == primitiveType) {
        ...
        self->asset = [[GLES2RectangleAsset2 alloc] init:1.0f height:1.0f color:GLES2Color.white bufferType:bufferType];
    }
