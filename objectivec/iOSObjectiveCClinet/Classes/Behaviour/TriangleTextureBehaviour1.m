...
@interface TriangleTextureBehaviour1 ()
@end
@implementation TriangleTextureBehaviour1
@synthesize asset;
- (id)init {
    self = [super init];
    ...
    if (0 == primitiveType) {
        self->asset = [[GLES2TriangleAsset1 alloc] init:1.0f height:1.0f color:GLES2Color.white bufferType:bufferType];
    } else {
        self->asset = [[GLES2TriangleAsset2 alloc] init:1.0f height:1.0f color:GLES2Color.white bufferType:bufferType];
    }
