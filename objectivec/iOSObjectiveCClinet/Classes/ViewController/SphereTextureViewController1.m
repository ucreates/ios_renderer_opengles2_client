...
#import "SphereTextureViewController1.h"
...
@interface SphereTextureViewController1 ()
@property GLES2Renderer* renderer;
@property NSMutableArray<SphereTextureBehaviour1*>* behaviours;
@end
@implementation SphereTextureViewController1
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<SphereTextureBehaviour1*> alloc] init];
    SphereTextureBehaviour1* behaviour = [[SphereTextureBehaviour1 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (SphereTextureBehaviour1* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
