...
#import "TriangleTextureViewController1.h"
#import "TriangleTextureBehaviour1.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES2Renderer.h"
@interface TriangleTextureViewController1 ()
@property GLES2Renderer* renderer;
@property NSMutableArray<TriangleTextureBehaviour1*>* behaviours;
@end
@implementation TriangleTextureViewController1
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TriangleTextureBehaviour1*> alloc] init];
    TriangleTextureBehaviour1* behaviour = [[TriangleTextureBehaviour1 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TriangleTextureBehaviour1* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
