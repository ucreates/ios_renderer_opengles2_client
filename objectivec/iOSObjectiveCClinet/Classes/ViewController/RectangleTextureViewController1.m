...
#import "RectangleTextureViewController1.h"
#import "RectangleTextureBehaviour1.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES2Renderer.h"
@interface RectangleTextureViewController1 ()
@property GLES2Renderer* renderer;
@property NSMutableArray<RectangleTextureBehaviour1*>* behaviours;
@end
@implementation RectangleTextureViewController1
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<RectangleTextureBehaviour1*> alloc] init];
    RectangleTextureBehaviour1* behaviour = [[RectangleTextureBehaviour1 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (RectangleTextureBehaviour1* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
