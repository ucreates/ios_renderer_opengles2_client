...
#import "CubeTextureViewController1.h"
#import "CubeTextureBehaviour1.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES2Renderer.h"
@interface CubeTextureViewController1 ()
@property GLES2Renderer* renderer;
@property NSMutableArray<CubeTextureBehaviour1*>* behaviours;
@end
@implementation CubeTextureViewController1
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<CubeTextureBehaviour1*> alloc] init];
    CubeTextureBehaviour1* behaviour = [[CubeTextureBehaviour1 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (CubeTextureBehaviour1* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
